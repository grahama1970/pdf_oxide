...
def test_nist_page_45_discussion_has_semantic_role():
    ...
    assert discussion.get("type") == "paragraph_block"
    assert discussion.get("semantic_role") == "discussion"
    assert discussion.get("source_type") == "Body"
    assert discussion.get("toc_path") == ["toc:0014", "toc:0015"]
