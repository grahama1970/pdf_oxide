...
| Latest failure signature | `scillm_chat_review_provider_quota_exhausted`; Tau diagnostic receipt at `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/quota-canary-receipt.json` |
