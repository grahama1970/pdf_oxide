...
| `tau_issue_123` | Tau-owned timeout/quota/route-exhaustion classifier added with live root-cause receipts; `vlm-free2` remains unavailable after a resumed canary and a `local-text` alternate canary is route-exhausted, so PDF Lab payload shape is not the active blocker; Tau-owned `$ask webkimi` advisory review confirms no legitimate `pdf_oxide` self-unblock exists under the current gate | `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/page39-diagnostic-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/quota-canary-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/local-text-canary-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/vlm-free2-resume-canary-20260721T154322Z-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/webgpt_route_unblock_attempt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/ask_webkimi_route_unblock_assessment.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/tau-audit-summary.json`, `https://github.com/grahama1970/tau/issues/123#issuecomment-5035953118`, `https://github.com/grahama1970/tau/issues/123#issuecomment-5036636615` | Tau `origin/main` at `915a819f97ac3f7e975b45b3afdcf809320cce78` |
...
| Field | Value |
|-------|-------|
| Page | blocked pending `vlm-free2` provider quota/rate-limit recovery or an approved alternate Tau model route proven by a Tau canary PASS |
| Defect class | to be selected from fresh current-extraction/model-review evidence |
| Observed failure | page39 live second-pass review through Tau commit `b48d815c34ee603e79f4c6f64edcfc92ccf3d8d4` timed out three times at the 120s gate with signature `scillm_chat_review_timeout+review_response_not_parseable@120s`; page401 then hit the same signature on a valid 854883-byte request; Tau commit `7009e45461dfd8fb9bb5c1fe56ebcd339941b50f` preserved the fail-closed short-canary timeout receipt, Tau commit `915a819f97ac3f7e975b45b3afdcf809320cce78` classifies the longer `vlm-free2` live canary as `scillm_chat_review_provider_quota_exhausted` with HTTP `429`, a Tau-owned `local-text` canary failed as `scillm_chat_review_route_exhausted` with HTTP `502`, and the resumed `vlm-free2` Tau canary at `2026-07-21T15:43:22Z` timed out through both primary and diagnosis budgets |
| Handoff evidence | `/home/graham/workspace/experiments/pdf_oxide-gs001/local/HANDOFF.md`, measured-position table |
| Candidate artifacts to inspect first | `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/page39-diagnostic-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/quota-canary-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/local-text-canary-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/vlm-free2-resume-canary-20260721T154322Z-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/webgpt_route_unblock_attempt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/ask_webkimi_route_unblock_assessment.json`, Tau commit `915a819f97ac3f7e975b45b3afdcf809320cce78`, and a future Tau canary PASS receipt proving route recovery or approved model-route replacement |
