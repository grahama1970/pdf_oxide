...
| `tau_issue_123` | Tau-owned timeout classifier added and issue closed with live root-cause receipt; the blocker is now the external SciLLM/Ollama route not answering a minimal Tau canary, not PDF Lab payload shape | `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/page39-diagnostic-receipt.json`, `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/tau-audit-summary.json`, `https://github.com/grahama1970/tau/issues/123#issuecomment-5035757958` | Tau `origin/main` at `7009e45461dfd8fb9bb5c1fe56ebcd339941b50f` |
...
| Latest failure signature | `scillm_chat_review_service_unresponsive`; Tau diagnostic receipt at `artifacts/pdf_lab/tau_issue123_timeout_classification_20260721/page39-diagnostic-receipt.json` |
